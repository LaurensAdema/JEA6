...
public class Profile implements Serializable
{
    ...
    public Profile(ma.ade.kwetter2.database.objects.Profile profile)
    {
    ...
    public ma.ade.kwetter2.database.objects.Profile Convert()
    {
        return new ma.ade.kwetter2.database.objects.Profile(this);
    }
}
