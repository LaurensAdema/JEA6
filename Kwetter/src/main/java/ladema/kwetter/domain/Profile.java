...
public class Profile implements Serializable
{
    ...
    public Profile(ladema.kwetter.database.objects.Profile profile)
    {
    ...
    public ladema.kwetter.database.objects.Profile Convert()
    {
        return new ladema.kwetter.database.objects.Profile(this);
    }
}
