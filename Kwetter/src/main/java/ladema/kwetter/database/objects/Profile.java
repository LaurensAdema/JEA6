package ladema.kwetter.database.objects;
...
public class Profile implements Serializable {
    ...
    public Profile(ladema.kwetter.domain.Profile profile)
    {
    ...
    public ladema.kwetter.domain.Profile Convert()
    {
        return new ladema.kwetter.domain.Profile(this);
    }
}
